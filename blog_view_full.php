...
$output = null;
  foreach($res as $key  => $c) {
	...
	if(isset($_SESSION['user'])){
	  $output .= " <div class = 'newsResult'><div class = 'title'><a href = 'blog_view.php?slug={$c -> slug}'>{$title}</a></div> <div class='updated'>{$updated}</div> <div class  ='user'><a href='user.php?id={$id}'> {$author}</a></div><div class = 'data'>{$data}</div> <div class = 'btn btn-default' ><a href='blog_edit_single.php?id={$c->id}'>Update</a></div> <div class = 'btn btn-default' ><a href='create.php?id={$c->id}'>Create</a> </div><div class = 'btn btn-default' ><a href='blog_edit_multi.php?id={$c->id}'>Edit all</a></div><div class = 'btn btn-default' ><a href='delete.php?id={$c->id}'>Delete </a></div></div> ";
	}else {
	   $output .= " <div class = 'newsResult'><div class = 'title'><a href = 'blog_view.php?slug={$c -> slug}'>{$title}</a></div>  <div class  ='user'><a href='user.php?id={$id}'> {$author}</a></div><div class = 'data'>{$data}</div> <div class = 'btn btn-default'><a href='blog_view.php'>Back to all</a></div></div> ";
	}
	
	}
	
	// Create the data array which is to be used in the template file.
	$alpha ['title'] = "All news";
