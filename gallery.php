...
// echo "GALLERY_BASEURL " .  GALLERY_BASEURL . " ";
...
is_dir ( GALLERY_PATH ) or errorMessage ( 'The gallery dir is not a valid directory.' ) . "path is: ". $path;
substr_compare ( GALLERY_PATH, $pathToGallery, 0, strlen ( GALLERY_PATH ) ) == 0 
or errorMessage ( 'Security constraint: Source gallery is not directly below the directory GALLERY_PATH.'  );

// echo "path is: " . $path . " ";
 
// echo "pathtoGallery :" . $pathToGallery . " ";
